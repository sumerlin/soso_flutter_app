...
import '../../controllers/PagingData.dart';
import 'page_state.dart';
//M：数据item model , S ：PagingState 子类状态model
abstract class PagingController<M,S extends PagingState<M>> extends GetxController{
  ...
  Future<List<M>?> _loadData() async {
    ...
    PagingData<M>? pagingData = await loadData( pagingState.pageIndex);
  ...
  /// 最终加载数据的方法
  Future<PagingData<M>?> loadData(int  pageIndex);
